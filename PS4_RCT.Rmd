...
stargazer(ra, rb, rc, rd, type="text", header=FALSE, title="Randomization Balance on Observables at Baseline", 
                     style="qje", 
...
stargazer(r4, r5, r6, r7, type="text", header=FALSE, title="Program Participation (Migration) Rates", 
                     style="qje", 
...
```{r, Q9, results ='asis'}
stargazer(r8, r9, type="text", header=FALSE, title="Effects of Migration on Consumption Among Remaining Household Members in 2008", 
                     style="qje", 
