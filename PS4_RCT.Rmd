...
Hint: You will need to construct a new variable to run these estimates. 
 ...
 + walls_good + subsistencer1 + num_adltmalesr1 + num_childrenr1 + exp_total_pc_r1 + bankedr1, 
...
r11 <- felm(average_exp2 ~ ITT + + walls_good + subsistencer1 + num_adltmalesr1 + num_childrenr1 + bankedr1 + exp_total_pc_r1 + monga + dhaka_network + constrainedr1|upazila|0|village, data=Round2_f_sub)
